...
// StylePreservation defines the rules for maintaining the original
...
const StylePreservation = `- Preserve the original tone, voice, and style of the content when making corrections or suggestions
