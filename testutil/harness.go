...
type VectorDB interface {
	Search(version string, queryEmbedding []float64, topK int) ([]tools.SearchResult, error)
...
func (m *MockVectorDB) Search(version string, queryEmbedding []float64, topK int) ([]tools.SearchResult, error) {
	if m.SearchFunc != nil {
